...
export WIND_DETECTION_LOW_POWER ?= 0
ifeq ($(WIND_DETECTION_LOW_POWER),1)
KBUILD_CPPFLAGS += -DWIND_DETECTION_LOW_POWER
endif
...
KBUILD_CPPFLAGS += -DIS_REFRESH_IRK_ON_BT_LINK_CHANGES
...
#export VOB_ENCODING_ALGORITHM ?= 3
...
export VOB_ENCODING_ALGORITHM := 2
export OPUS_CODEC := 1
export SHA256_ROM ?= 1
ifeq ($(LIBC_ROM),1)
...
export VOB_ENCODING_ALGORITHM := 4
endif
KBUILD_CPPFLAGS += -DGLOBAL_SRAM_KISS_FFT
# 1: ADPCM
# 2: OPUS
...
ifneq ($(VOB_ENCODING_ALGORITHM),0)
KBUILD_CPPFLAGS += -DVOB_ENCODING_ALGORITHM=$(VOB_ENCODING_ALGORITHM)
endif
...
ifneq ($(filter best1400 best2300 best2300p best1305,$(CHIP)),)
...
export TWS_SWITCH_ACCORDING_NOISE
endif
