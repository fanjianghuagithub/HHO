...
#define DEFAULT_COEFF_FOR_MIX_PROMPT_FOR_MUSIC      0.1
#define DEFAULT_COEFF_FOR_MIX_MUSIC_FOR_MUSIC       0.4
#define DEFAULT_COEFF_FOR_MIX_PROMPT_FOR_CALL       0.1
...
TRACE(0, "................promptId = %d",promptId);
if (app_tws_ibrt_tws_link_connected())
{
    if(promptId == AUD_ID_BT_CHARGE_PLEASE)
	{
         isPlayingLocally = true;
	}
	else
...
void audio_prompt_stop_playing(void)
{
    ...
    if (app_audio_list_rmv_callback(&aud_status, &status_next,APP_BT_SETTING_Q_POS_HEAD, true))
    {
        ...
        app_ibrt_if_voice_report_handler(status_next.aud_id, PROMOT_ID_BIT_MASK_MERGING|PROMOT_ID_BIT_MASK_CHNLSEl_ALL);
#endif
    }
